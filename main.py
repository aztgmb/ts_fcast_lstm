...
from data_transform import rearrange_data, split_data, transform_data
...
df_rearr = rearrange_data(df)
splt_dt_1 = '2018-04-04'
splt_dt_2 = '2018-04-05'
X_train, Y_train, X_test, Y_test = split_data(df_rearr, splt_dt_1, splt_dt_2)
x_rtrain, y_rtrain, x_rtest, y_rtest, x_tr_t, x_tst_t = transform_data(X_train, Y_train, X_test, Y_test)
