# -*- coding: utf-8 -*-
"""data_transformer_class.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1TKG_df_FRsWTGOnscUeO5oJPISvvvMNV
"""
...
class FXDataTransformer:

    def _init_(self):
      pass

    def rearrange_data(self, fx_df):
    ...
    def split_data(self, data_brjp_rev, splt_dt_1, splt_dt_2):
    ...
    def scale_data(self, x_train_bjrp, y_train_bjrp, x_test_bjrp, y_test_bjrp):
